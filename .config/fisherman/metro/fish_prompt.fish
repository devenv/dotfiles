function fish_prompt
    ...
    #if set branch_name (git_branch_name | cut -c1-10)
    if set branch_name (git_branch_name)
        ...
        if git_is_staged
            ...
            if git_is_dirty
                set git_color $git_color ffffff 2989FF
            end

        else if git_is_dirty
            set git_color white 2989FF
    ...
    segment $base_color ""
    segment D7FFB1 242424 (date "+%H:%M:%S")
